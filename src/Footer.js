...
function Footer() {
  return (
    <footer className="bg-[#003049] pt-4"> {/* Wrapper with blue background to showcase the rounded corners */}
    <div className="bg-white text-[#003049] py-8 px-4 rounded-tl-[40px] rounded-tr-[40px]">
