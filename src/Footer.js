...
function Footer() {
  return (
    <footer>
    <div className="bg-white text-[#003049] py-12 px-4">
  ...
  {/* Social Icons */}
  <div className="flex gap-16 pl-80 pt-8">
    <img
    ...
    {/* Contact Information */}
    <div className="flex flex-col items-center md:items-end text-sm gap-2 mt-8 md:mt-0">
      <div>
  ...
  <p className="text-center pr-80 pl-80">
  ...
  <div className="w-full  mx-auto mt-12 border-t border-[#003049] pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-center md:text-left gap-4"></div>
