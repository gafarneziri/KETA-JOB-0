  ...
  return (
    <div className="min-h-screen bg-[#003049] flex justify-center items-center py-12">
      ...
      <Link
        ...
        style={{ transform: 'scaleY(1.7)', height: '60px' }}
      >
        &lt;
      </Link>
      ...
      <form
        ...
        className="bg-white rounded-[30px] shadow-lg p-12 w-full max-w-[1160px] mt-20"
      >
        {/* Title */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className="w-[223px] h-12 px-4 border border-gray-300 rounded-full text-[#003049] text-base leading-tight"
                >
        ...
        <div className="ml-2 mb-10">
          <h3 className="text-[#003049] font-bold text-lg uppercase mb-6">Dokumente</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-4 mx-[350px] gap-x-12 ml-2">
            {['CV', 'Diplome', 'Arbeitszeugnisse', 'Bild Hochladen', 'Sonstiges'].map((doc, index) => (
              <div key={index}>
                <label className="block text-[#003049] font-light mb-1">{doc}</label>
                <input
                  type="file"
                ...
                <label htmlFor={`file-upload-${index}`}>
                  <div className="bg-[#003049] text-white uppercase w-[230px] py-3 rounded-full font-light hover:bg-[#002136] transition duration-200 text-center cursor-pointer">
                    Datei hochladen
                  </div>
                </label>
                {selectedFiles[doc] && (
        ...
        <div className="ml-2 mb-10">
          ...
          <textarea
            ...
            className="w-[480px] h-32 p-4 border border-gray-300 rounded-[20px]"
          ></textarea>
        </div>
        <div className="flex items-center -mt-8 space-x-4 mb-8 ml-2">
          <input
            type="radio"
            className="h-5 w-5 text-[#003049] border-gray-300 rounded-[10px]"
            required
          />
        ...
        <div className="flex justify-start ml-2">
          <button
            type="submit"
            className="bg-[#003049] text-white uppercase px-10 py-4 rounded-full hover:bg-[#002136] transition"
          >
            Bewerbung Senden
          </button>
        </div>
