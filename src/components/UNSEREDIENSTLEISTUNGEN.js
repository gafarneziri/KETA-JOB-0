...
<div className="flex-grow border-t border-white -ml-24 ml-20 mt-6"></div>
  ...
  <div className="relative bg-[#003049] text-white  rounded-lg p-6 max-w-7xl shadow-lg border border-white m-8 mx-auto mb-16">
    ...
    <div className="text-left mt-4">
      ...
      <div className="flex justify-left mt-8 mb-10">
        <button  onClick={() => navigate('/bewerbenbutton')} className="bg-white text-[#003049] font-Montserrat py-2 px-4 rounded-full hover:bg-gray-200 transition duration-300">
          JETZT BEWERBEN
        </button>
      </div>
    </div>
  ...
  <div className="relative bg-[#003049] text-white rounded-lg p-6 max-w-7xl shadow-lg border border-white m-8 mx-auto mb-16">
    ...
    <div className="text-left mt-4">
      ...
      <div className="flex justify-left mt-8 mb-10">
        <button  onClick={() => navigate('/bewerbenbutton')} className="bg-white text-[#003049] font-Monsterrat py-2 px-4 rounded-full hover:bg-gray-200 transition duration-300">
          JETZT BEWERBEN
        </button>
      </div>
    </div>
  ...
  {/* Box 3 - STELLENPOOL */}
  <div className="relative bg-[#003049] text-white rounded-lg p-6 max-w-7xl shadow-lg border border-white m-8 mx-auto mb-[30px]">
    <div className="flex justify-center -mt-14">
      <div className="bg-[#003049] p-2 rounded-full">
