  ...
  return (
    <div className="min-h-screen bg-[#003049] flex justify-center items-center py-12">
      ...
      <form
        ...
        className="bg-white rounded-[30px] shadow-lg p-12 w-full max-w-[1160px] mt-24"
      >
        {/* Title */}
        ...
        <div className="flex justify-start ml-2">
          <button
            type="submit"
            className="bg-[#003049] text-white uppercase px-10 py-4 rounded-full font-semibold hover:bg-[#002136] transition"
          >
            Bewerbung Senden
          </button>
        </div>
